...
<!DOCTYPE html><html lang="en">
    <head>
     ...
     <body>
      ...
      <form action="rmip.py" method="POST">
...
'''
	...
	for row in out:
		rep='''<div class="col-sm-4">
                            <div class="thumbnail">
                                <img src="http://127.0.0.1/AutoLab/img/1.png" alt="no image">
                                <div class="caption">'''
		print rep
...
<center><button type="submit" name="submit" class="btn btn-primary btn-lg">Submit</button><br><br></center>
	...
	print "<body style="'background-color:linen;padding-top:100px;'"><center><h1 style="'color:blue;'"><h1>NO CLIENT AVAILABLE</h1></center></body>" 
