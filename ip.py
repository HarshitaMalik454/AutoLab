...
if value==[]:
	...
	print  "<meta http-equiv='refresh' content='1;http://127.0.0.1/cgi-bin/AutoLAB/install.py'>"
else:
	...
	for i in value:
		...
		if len(out)>0:
			for row in out:
				f.write(row[1])
				f.close();
		print  "<meta http-equiv='refresh' content='1;http://127.0.0.1/AutoLab/app.html'>"
